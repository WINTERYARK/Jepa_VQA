...
class Predictor(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # Determine the dimension for the transformer decoder
        model_dim = predictor_embed_dim if predictor_embed_dim is not None else embed_dim

        # Initialize the transformer-based decoder
        self.decoder = Encoder(
            dim=model_dim, depth=depth, heads=num_heads, layer_dropout=layer_dropout
        )
